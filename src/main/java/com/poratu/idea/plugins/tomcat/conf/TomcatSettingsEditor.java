...
import com.poratu.idea.plugins.tomcat.setting.TomcatSettingsConfigurable;
...
public class TomcatSettingsEditor extends SettingsEditor<TomcatRunConfiguration> {
    ...
    protected JComponent createEditor() {
        ...
        configrationButton.addActionListener(e -> ShowSettingsUtil.getInstance().showSettingsDialog(project, TomcatSettingsConfigurable.class));
