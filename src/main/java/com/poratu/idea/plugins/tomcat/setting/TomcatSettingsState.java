...
public class TomcatSettingsState implements PersistentStateComponent<TomcatSettingsState> {

    @XCollection(elementTypes = TomcatInfo.class)
    private final List<TomcatInfo> tomcatInfos = new ArrayList<>();

    public static TomcatSettingsState getInstance() {
        return ApplicationManager.getApplication().getService(TomcatSettingsState.class);
    }
    ...
    @Nullable
    @Override
    public TomcatSettingsState getState() {
        return this;
    }

    @Override
    public void loadState(@NotNull TomcatSettingsState tomcatSettingsState) {
    ...
    public static TomcatInfo createTomcatInfo(String tomcatHome) {
        return createTomcatInfo(tomcatHome, TomcatSettingsState::generateTomcatName);
    }
